  ...
  '@media': {
    '(prefers-color-scheme: light)': {
      vars: {
        ...
        [theme.color.token.button.normal.icon]: theme.color.palette.gray600,
        ...
        [theme.color.token.button.normal.hover.icon]: theme.color.palette.gray600,
        ...
        [theme.color.token.button.ghost.icon]: theme.color.palette.gray600,
        ...
        [theme.color.token.button.ghost.hover.icon]: theme.color.palette.gray600,
