...
const validateInput = (input: Uint8Array, index: number) => {
...
const validateExifBlock = (input: Uint8Array, index: number) => {
  ...
  throw new Error('Invalid EXIF byte alignment');
};

const isEXIF = (input: Uint8Array) => {
...
const extractOrientation = (exifBlock: Uint8Array, isBigEndian: boolean) => {
  ...
  throw new Error('Invalid EXIF block');
};
