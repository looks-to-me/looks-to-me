  ...
  '@media': {
    '(prefers-color-scheme: dark)': {
      vars: {
        ...
        [theme.color.token.button.normal.hover.text]: theme.color.palette.white,
        [theme.color.token.button.normal.hover.icon]: theme.color.palette.gray300,
        ...
        [theme.color.token.button.normal.disabled.icon]: theme.color.palette.gray500,
        ...
        [theme.color.token.button.primary.disabled.icon]: theme.color.palette.gray200,
        ...
        [theme.color.token.button.danger.icon]: theme.color.palette.red400,
        ...
        [theme.color.token.button.danger.disabled.icon]: theme.color.palette.red600,
        ...
        [theme.color.token.button.ghost.text]: theme.color.palette.white,
        [theme.color.token.button.ghost.icon]: theme.color.palette.gray300,
        [theme.color.token.button.ghost.border]: theme.color.palette.gray600,
        [theme.color.token.button.ghost.background]: 'transparent',
        [theme.color.token.button.ghost.hover.text]: theme.color.palette.white,
        [theme.color.token.button.ghost.hover.icon]: theme.color.palette.gray300,
        ...
        [theme.color.token.button.ghost.disabled.icon]: theme.color.palette.gray500,
        ...
        [theme.color.token.popover.background]: theme.color.palette.gray800,
        ...
        [theme.color.token.badge.normal.background]: theme.color.palette.gray800,
        [theme.color.token.badge.normal.border]: theme.color.palette.gray400,
        [theme.color.token.badge.normal.text]: theme.color.palette.gray100,

        [theme.color.token.badge.primary.background]: theme.color.palette.green900,
        [theme.color.token.badge.primary.border]: theme.color.palette.green400,
        [theme.color.token.badge.primary.text]: theme.color.palette.green100,
      },
    },
  },
});
